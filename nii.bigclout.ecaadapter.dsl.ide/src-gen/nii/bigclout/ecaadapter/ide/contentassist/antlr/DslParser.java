		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getSpecificationAccess().getIfdoAssignment_3(), "rule__Specification__IfdoAssignment_3");
					put(grammarAccess.getSpecificationAccess().getElseIfDoAssignment_4(), "rule__Specification__ElseIfDoAssignment_4");
					put(grammarAccess.getSpecificationAccess().getElseDoAssignment_5(), "rule__Specification__ElseDoAssignment_5");
